        ...
        <div>
            <body style={{margin: 0}}>
                <div style={{display:"grid", gridTemplateColumns:"repeat(auto-fill, minmax(250px, 1fr));"}}>
                    <div style={{boxShadow: "4px 4px 20px black", borderRadius:"3px", backgroundColor:"white", height:"auto", width:"96vw", marginLeft:"2vw", marginRight:"2vw", marginTop:"20px", paddingBottom:"5px", paddingTop:"5px"}}>
